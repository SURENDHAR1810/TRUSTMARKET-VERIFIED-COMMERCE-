      ...
      return (
         <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
            <div className="text-center animate-in zoom-in fade-in duration-500">
               ...
               <p className="text-slate-400 text-lg">Your verified {product.name} is on its way to {formData.city}.</p>
            </div>
         </div>
      );
   }
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                           <input
                              ...
                              className={`w-full bg-[#0f172a] border ${errors.firstName ? 'border-red-500' : 'border-slate-700'} rounded-lg p-3 text-sm focus:border-indigo-500 outline-none`}
                           />
                        ...
                        <div className="space-y-1">
                           <input
                              ...
                              onChange={handleChange}
                              className={`w-full bg-[#0f172a] border ${errors.lastName ? 'border-red-500' : 'border-slate-700'} rounded-lg p-3 text-sm focus:border-indigo-500 outline-none`}
                           />
                        ...
                        <div className="col-span-2 space-y-1">
                           <input
                              ...
                              onChange={handleChange}
                              className={`w-full bg-[#0f172a] border ${errors.address ? 'border-red-500' : 'border-slate-700'} rounded-lg p-3 text-sm focus:border-indigo-500 outline-none`}
                           />
                           {errors.address && <p className="text-red-400 text-xs ml-1">{errors.address}</p>}
                        </div>
                        ...
                        <div className="space-y-1">
                           <input
                              ...
                              value={formData.city}
                              onChange={handleChange}
                              className={`w-full bg-[#0f172a] border ${errors.city ? 'border-red-500' : 'border-slate-700'} rounded-lg p-3 text-sm focus:border-indigo-500 outline-none`}
                           />
                        ...
                        <div className="space-y-1">
                           <input
                              ...
                              onChange={handleChange}
                              className={`w-full bg-[#0f172a] border ${errors.zipCode ? 'border-red-500' : 'border-slate-700'} rounded-lg p-3 text-sm focus:border-indigo-500 outline-none`}
                           />
                           {errors.zipCode && <p className="text-red-400 text-xs ml-1">{errors.zipCode}</p>}
                        </div>
                     </div>
                  </div>
